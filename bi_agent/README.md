...
2. Click "My Access Tokens" → Copy your personal token

**Getting Board IDs:**
1. Open your board in monday.com
2. The URL will be: `https://monday.com/boards/BOARD_ID_HERE`
...
**Import steps:**
1. monday.com → + Add → Import data → Excel
2. Map columns to appropriate types (see Column Mapping below)
3. Copy the board IDs from the URLs into your `.env`
